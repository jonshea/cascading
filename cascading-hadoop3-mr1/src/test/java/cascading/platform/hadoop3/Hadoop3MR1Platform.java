...
import cascading.flow.hadoop3.Hadoop3MR1FlowConnector;
import cascading.flow.hadoop3.Hadoop3MR1Planner;
...
/**
 * Class Hadoop3Platform is automatically loaded and injected into a {@link cascading.PlatformTestCase} instance
 * so that all *PlatformTest classes can be tested against Apache Hadoop 2.x.
 */
public class Hadoop3MR1Platform extends BaseHadoopPlatform<JobConf>
  {
  private static final Logger LOG = LoggerFactory.getLogger( Hadoop3MR1Platform.class );
  private transient static MiniDFSCluster dfs;
  private transient static MiniMRClientCluster mr;

  public Hadoop3MR1Platform()
    {
    }
  ...
  public FlowConnector getFlowConnector( Map<Object, Object> properties )
    {
    return new Hadoop3MR1FlowConnector( properties );
    }
...
//      conf.set( "yarn.scheduler.capacity.root.default.capacity", "100" );
    ...
    Hadoop3MR1Planner.copyProperties( configuration, globalProperties ); // copy any external properties

    Hadoop3MR1Planner.copyConfiguration( properties, configuration ); // put all properties on the jobconf
    }
  }
